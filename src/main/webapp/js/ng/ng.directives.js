angular.module('app.main', [])
	...
	.directive('action', function($location, $state ) {
		return {
			restrict: 'A',
			link: function(scope, element, attrs) {
				/*
				    ...
				    userLogout: function($this){
						...
						function logout() {
				          ...
				          $state.transitionTo(view);
						   $.root_.removeClass('animated fadeOutUp');
